...
"}")
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(".\\ui\\../resources/images/splash_img.jpg"))
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_4.setText(_translate("SplashScreen", "A pacemaker is a device that sends small electrical impulses to the heart muscle to maintain a suitable heart rate or to stimulate the lower chambers of the heart (ventricles). A pacemaker may also be used to treat fainting spells (syncope), congestive heart failure and cardiomyopathy."))
